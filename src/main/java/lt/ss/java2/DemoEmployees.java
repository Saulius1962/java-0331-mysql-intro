...
import lt.ss.java2.services.EmployeeMap;
...
//        getSalariesByEmp(10001, 100);
    ...
    static void getSalariesByEmp(int empNo, int limit) {
        try (
                Connection conn = DBService.getConnection("jdbc:h2:mem:", "sa", "");  // 1 zingsnis
                PreparedStatement statement = conn.prepareStatement(
    ...
    static void updateEmployee(int empNo, String firstName, String lastName) {
        try (
                Connection conn = DBService.getConnection("jdbc:h2:mem:", "sa", "");
                PreparedStatement statement = conn.prepareStatement(
